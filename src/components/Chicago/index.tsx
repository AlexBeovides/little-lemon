    ...
    <Container id="about">
      <Content>
        ...
        <p className="lead-txt">
          Little Lemon is owned by two Italian brothers, Chocolate and El Memba, who moved to the United States to pursue their shared dream of owning a restaurant.
        </p>
        <p className="lead-txt">
